...
<body>
    ...
    <?php
    //tüdrukud
    $tydrukud = array("mari","kati","miku","liisa","maria","sofia","annika","marleen");
    sort($tydrukud);
    ...
    "WVWED7AJ7DW43,1402", "1FTKR1AD3AP316066", "WBAKF5C52CE612586", "1FTNX2A57AE16083", "WAUCFAFR1AA166821", "SCFFDAAM3EG486065", "1G4PR5SK5F4821043", 
    ...
    sort ($hnimed);
    foreach ($hnimed as $tnimi) {
        echo ($tnimi).", "; 
    }
    //esimene ja viimane element
        echo "<br>".$hnimed[0];
        echo "<br>".$hnimed[count($hnimed)-1];
